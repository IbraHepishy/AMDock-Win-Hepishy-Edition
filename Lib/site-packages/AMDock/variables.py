...
class Variables:
    def __init__(self):
        ...
        self.extprg_path = os.path.join(os.path.dirname(__file__), 'programs')
        self.doc_path = os.path.join(os.path.dirname(self.this_python), 'Doc')
        self.python_lib = os.path.join(os.path.dirname(self.this_python), 'Lib', "site-packages")
        self.pdb2pqr_py = str(os.path.join(self.python_lib, 'pdb2pqr', 'pdb2pqr.py'))
        self.prepare_gpf4_py = str(os.path.join(self.python_lib, 'AutoDockTools', 'Utilities24', 'prepare_gpf4.py'))
        self.prepare_gpf4zn_py = str(os.path.join(self.extprg_path, 'prepare_gpf4zn.py'))
        self.prepare_dpf_py = str(os.path.join(self.python_lib, 'AutoDockTools', 'Utilities24', 'prepare_dpf42.py'))
        self.prepare_receptor4_py = str(os.path.join(self.python_lib, 'AutoDockTools', 'Utilities24',
                                                     'prepare_receptor4.py'))
        self.prepare_ligand4_py = str(os.path.join(self.python_lib, 'AutoDockTools', 'Utilities24',
                                                   'prepare_ligand4.py'))
        ...
        self.vina_exec = os.path.join(self.extprg_path, 'vina.exe')
        self.autogrid = os.path.join(self.extprg_path, 'autogrid4.exe')
        self.autodock = os.path.join(self.extprg_path, 'autodock4.exe')
        self.autoligand_py = os.path.join(self.extprg_path, 'AutoLigand.py')
        self.pymol = os.path.join(self.python_lib, 'pymol', '__init__.py')
        self.plip = os.path.join(os.path.dirname(self.this_python), 'plip', 'env')
        self.aln_pymol = os.path.join(self.extprg_path, 'protein_align_pymol.py')
        self.openbabel = os.path.join(self.python_lib, 'openbabel', 'obabel.exe')
        ...
        self.prog_title = '<html><head/><body style="font-family:times;color:#000000;text-decoration: ' \
                          ...
                          'AutoDock Vina (Hepishy\'s Edition)</span></p></body></html> '
