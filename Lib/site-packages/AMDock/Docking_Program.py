...
class AMDock(QtGui.QMainWindow, Variables):
    def __init__(self):
        ...
        self.version = "{}.{}.{} For Windows and Linux (Hepishy\'s Edition)".format(*self.numeric_version)
...
#     app.setApplicationName('AMDock: Assisted Molecular Docking for AutoDock and AutoDock Vina (Hepishy's Edition)')
#     splash = SplashScreen(QtGui.QPixmap(ob.splashscreen_path), app)
#     main = AMDock()
#     splash.finish(main)
#     main.setMinimumSize(1080, 740)
#     main.resize(1080, int(dw.height()*0.9))
#     main.setWindowTitle('AMDock: Assisted Molecular Docking with AutoDock4 and AutoDock Vina (Hepishy's Edition)')
